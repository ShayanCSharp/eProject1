...
$(document).ready(function () {
  ...
  $("#row2").waypoint(
    function () {
      $("#row2").addClass("animate__animated animate__slideInRight");
    },
    {
      offset: "50%",
    }
  ...
  $("#row4").waypoint(
    function () {
      $("#row4").addClass("animate__animated animate__slideInUp");
    },
    {
      offset: "50%",
    }
  ...
  $("#row5").waypoint(
    function () {
      $("#row5").addClass("animate__animated animate__slideInUp");
    },
    {
      offset: "70%",
    }
